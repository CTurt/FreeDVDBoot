...
| PS2 "Reading disc" for long time                                                   | This reason could be having modchip. You can disable the modchip by having the console powered off, and then powering it on by holding down (instead of quickly pressing) the power button, until you hear the laser moving sound, them immediately let it go. This worked on an SCPH-9xxxx model. |
